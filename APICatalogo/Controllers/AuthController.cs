...
public class AuthController : ControllerBase
{
    ...
    /// </summary>
    /// <param name="model">Um objeto do tupo UsuarioDTO</param>
    ...
    public async Task<IActionResult> RefreshToken(TokenModel tokenModel)
    {
        ...
        var accessToken = tokenModel.AccessToken ?? throw new ArgumentException(nameof(tokenModel.AccessToken));

        var refreshToken = tokenModel.RefreshToken ?? throw new ArgumentException(nameof(tokenModel.RefreshToken));

        var principal = _tokenService.GetPrincipalFromExpiredToken(accessToken!, _configuration);

        if (principal is null) return BadRequest("Invalid access/refresh token");
